...
["%","NnNwNwNwN","bwbWbWbWb"],["*","NwNnWnWnN","bWbwBwBwb"]],j=function(b,c){b=(""+b).toUpperCase();c=c?+c:2;for(var a=0;a<h.length;a++)if(b===h[a][0])return h[a][c]},k=[];d=function(b,c,a){this.codes=h;this.version="0.0.1";this.barcode=null;this.element=document.getElementById(b||"barcode");this.delimeter=a||"*";this.type=c||2;this.init()};d.prototype.toString=function(){return!this.barcode?"":(this.delimeter+this.barcode+this.delimeter).trim()};d.prototype.toBarcode=function(){var b=k.join(""),
...
2-d/2),d=0;d<c.length;d++){var g=j(c[d]);k.push("["+g+"]w");""===typeof g&&(g=j("-"));for(f=0;f<g.length;f++)a.fillStyle=0==f%2?"rgb(0,0,0)":"rgba(255,255,255, 0.0)",91>g.charCodeAt(f)?(a.fillRect(e,20,3,80),e+=3):(a.fillRect(e,20,1,80),e+=1);d!=c.length-1&&(a.fillStyle="rgba(255,255,255, 0.0)",a.fillRect(e,20,1,80),e+=1)}this.barcode=c;return b.toDataURL()};d.prototype.init=function(){var b=this.toDataURL();this.element.innerHTML='<img src="'+b+'" />'};window.Barcode39=d})();